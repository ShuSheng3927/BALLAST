...
for deploy in range(deploy_num):
    ...
    # acquisition
    acq_list = full_system_EIG(traj_data, space_grid, time_now)
...
with open('./traj_data_EIG.csv', 'a') as myfile:
...
with open('./metric_EIG.csv', 'a') as myfile:
